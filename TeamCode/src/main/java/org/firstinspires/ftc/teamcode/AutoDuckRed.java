...
@Config
@Autonomous(name = "Duck Red", group = "finalized")
public class AutoDuckRed extends LinearOpMode implements DogeOpMode {
...
//        runCommonPathAfterSplit();
    ...
    public void runCommonPathAfterSplit() {
        ...
        commander.runCommand(new DriveByEncoder(drive, SwampbotsUtil.inchToCount(-27.0), 0, 0.3, telemetry));
    }
